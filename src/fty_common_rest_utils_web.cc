...
get_mapping (const std::string& key)
{
    const static std::map <const std::string, const std::string> config_mapping = {
        ...
        {"FTY_DISCOVERY_DEFAULT_VALUES_STATUS",     "discovery/defaultValues/aux/status"},
        {"FTY_DISCOVERY_DEFAULT_VALUES_PRIORITY",   "discovery/defaultValues/aux/priority"},
        {"FTY_DISCOVERY_DEFAULT_VALUES_PARENT",     "discovery/defaultValues/aux/parent"},
        {"FTY_DISCOVERY_DEFAULT_VALUES_LINK_SRC",   "discovery/defaultValues/links/1/src"},
