#
#    fty-common-db - Provides common RestAPI tools for agents
#
...
This package contains shared library for fty-common-db: provides common restapi tools for agents
...
This package contains development files for fty-common-db: provides common restapi tools for agents
